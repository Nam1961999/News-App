...
async function getNews() {
    let apiURL = `https://newsapi.org/v2/top-headlines?q=${querySearch}&country=us&category=${dataUser.newsCategory}&apiKey=55ec824033084ce6ad6c8a707d078edc&page=${page}&pageSize=${dataUser.newsPerPage}`
